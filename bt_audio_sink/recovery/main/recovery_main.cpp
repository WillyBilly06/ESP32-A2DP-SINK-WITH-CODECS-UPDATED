...
// ============================================================
// AES-256 Key (32 bytes) - PLACEHOLDER! YOU MUST GENERATE YOUR OWN KEY!
// This key must match the one used to encrypt firmware files.
// Generate a new key with: python tools/encrypt_firmware.py --generate-key
//
// SECURITY WARNING: Do NOT use this all-zero key in production.
// Replace this placeholder with your own 32-byte secret before building.
